{
  security.pki.certificates = [
    ''
      ...
      -----END CERTIFICATE-----
      -----BEGIN CERTIFICATE-----
      
      uAIhAI+HE4zKg5s34+NGjlSGI+cz4P4qz6NJSbUfM/hZ5ICH
      -----END CERTIFICATE-----
    ''
  ];
}
